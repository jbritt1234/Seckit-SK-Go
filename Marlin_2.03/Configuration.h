 ...
 *
 */
//#define Z_MIN_PROBE_PIN 32 // Ernest for SK-Mini, P1_24 is Z max endstop. Don't know why Z_MAX_PIN not working.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 59, -3.8 }
